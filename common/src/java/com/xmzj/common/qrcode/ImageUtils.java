package com.xmzj.common.qrcode;
...
//        ImageUtils.scale("e:/abc.jpg", "e:/abc_scale.jpg", 2, true);//测试OK
        // 方法二：按高度和宽度缩放
//        ImageUtils.scale2("d:/jd.jpg", "d:/jd1.jpg",300 , 600, true);//测试OK
        
//        File srcfile = new File("d:/jd.jpg");
//        File distfile = new File("d:/jd1.jpg");
//        ImageUtils.reduceImg(srcfile, distfile, 360, 200);
    	
    	  ImageUtils.createThumbnail("d:/jd.jpg", "d:/jd1.jpg", 360, 200);
